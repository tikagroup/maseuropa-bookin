...
/**
 * This class stands for FAParamOccupationBoatWS StructType
 * @subpackage Structs
 */
class FAParamOccupationBoatWS extends AbstractStructBase
{
    /**
     * The num_adults
    ...
    public $age_children;
    /**
     * Constructor method for FAParamOccupationBoatWS
     * @uses FAParamOccupationBoatWS::setNum_adults()
     * @uses FAParamOccupationBoatWS::setNum_children()
     * @uses FAParamOccupationBoatWS::setAge_children()
     * @param int $num_adults
     * @param int $num_children
     * @param string $age_children
     */
    public function __construct($num_adults = null, $num_children = null, $age_children = null)
    {
        $this
     ...
     * @param int $num_adults
     * @return \Maseuropa\Booking\StructType\FAParamOccupationBoatWS
     */
