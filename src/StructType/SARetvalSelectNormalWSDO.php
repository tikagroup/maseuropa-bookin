...
/**
 * This class stands for SARetvalSelectNormalWSDO StructType
 * @subpackage Structs
 */
class SARetvalSelectNormalWSDO extends AbstractStructBase
{
    /**
     * The status
    ...
    public $tpv_amount;
    /**
     * Constructor method for SARetvalSelectNormalWSDO
     * @uses SARetvalSelectNormalWSDO::setStatus()
     * @uses SARetvalSelectNormalWSDO::setStatus_id()
     * @uses SARetvalSelectNormalWSDO::setLocator()
     * @uses SARetvalSelectNormalWSDO::setSupplier_name()
     * @uses SARetvalSelectNormalWSDO::setSupplier_category()
     * @uses SARetvalSelectNormalWSDO::setSupplier_description()
     * @uses SARetvalSelectNormalWSDO::setSupplier_address()
     * @uses SARetvalSelectNormalWSDO::setSupplier_city()
     * @uses SARetvalSelectNormalWSDO::setSupplier_province()
     * @uses SARetvalSelectNormalWSDO::setSupplier_country()
     * @uses SARetvalSelectNormalWSDO::setSupplier_phone()
     * @uses SARetvalSelectNormalWSDO::setAmount()
     * @uses SARetvalSelectNormalWSDO::setCancellation_fees()
     * @uses SARetvalSelectNormalWSDO::setNotes()
     * @uses SARetvalSelectNormalWSDO::setBooking_locator()
     * @uses SARetvalSelectNormalWSDO::setMandatory_information()
     * @uses SARetvalSelectNormalWSDO::setTpv_amount()
     * @param string $status
     * @param int $status_id
    ...
    public static function validateCancellation_feesForArrayConstraintsFromSetCancellation_fees(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $sARetvalSelectNormalWSDOCancellation_feesItem) {
            // validation for constraint: itemType
            if (!$sARetvalSelectNormalWSDOCancellation_feesItem instanceof \Maseuropa\Booking\StructType\SACancellationFeeWSDO) {
                $invalidValues[] = is_object($sARetvalSelectNormalWSDOCancellation_feesItem) ? get_class($sARetvalSelectNormalWSDOCancellation_feesItem) : sprintf('%s(%s)', gettype($sARetvalSelectNormalWSDOCancellation_feesItem), var_export($sARetvalSelectNormalWSDOCancellation_feesItem, true));
            }
        }
