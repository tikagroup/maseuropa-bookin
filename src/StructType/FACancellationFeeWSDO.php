...
/**
 * This class stands for FACancellationFeeWSDO StructType
 * @subpackage Structs
 */
class FACancellationFeeWSDO extends AbstractStructBase
{
    /**
     * The days_notice
    ...
    public $description;
    /**
     * Constructor method for FACancellationFeeWSDO
     * @uses FACancellationFeeWSDO::setDays_notice()
     * @uses FACancellationFeeWSDO::setNights()
     * @uses FACancellationFeeWSDO::setExpresado_en()
     * @uses FACancellationFeeWSDO::setAmount()
     * @uses FACancellationFeeWSDO::setDescription()
     ...
     * @param string $days_notice
     * @return \Maseuropa\Booking\StructType\FACancellationFeeWSDO
     */
