...
/**
 * This class stands for FAParamOccupationWS StructType
 * @subpackage Structs
 */
class FAParamOccupationWS extends AbstractStructBase
{
    /**
     * The num_occupation
    ...
    public $age_children;
    /**
     * Constructor method for FAParamOccupationWS
     * @uses FAParamOccupationWS::setNum_occupation()
     * @uses FAParamOccupationWS::setNum_adults()
     * @uses FAParamOccupationWS::setNum_children()
     * @uses FAParamOccupationWS::setAge_children()
     ...
     * @param int $num_occupation
     * @return \Maseuropa\Booking\StructType\FAParamOccupationWS
     */
